...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/order') && preg_match('#^/order/(?P<id>[^/]++)/detail$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/my')) {
            ...
            if (0 === strpos($pathinfo, '/my/order') && preg_match('#^/my/order/(?P<id>[^/]++)/cancel_refund$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
        ...
        if (0 === strpos($pathinfo, '/thread')) {
            ...
            if (preg_match('#^/thread/(?P<threadId>[^/]++)/post/(?P<postId>[^/]++)/subposts$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'thread_post_subposts')), array (  '_controller' => 'Topxia\\WebBundle\\Controller\\ThreadController::subpostsAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/navigation')) {
                ...
                if ($pathinfo === '/admin/navigation/seqs/update') {
            ...
            if (0 === strpos($pathinfo, '/admin/coin')) {
                ...
                // admin_coin_settings
                if ($pathinfo === '/admin/coin/settings') {
                ...
                if (0 === strpos($pathinfo, '/admin/coin/orders')) {
                    ...
                    if ($pathinfo === '/admin/coin/orders') {
                        return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\CoinController::ordersAction',  '_route' => 'admin_coin_orders',);
                    }

                    // admin_coin_orders_log
                    if (0 === strpos($pathinfo, '/admin/coin/orders/log') && preg_match('#^/admin/coin/orders/log/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_coin_orders_log')), array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\CoinController::logsAction',));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/coin/model')) {
                    // admin_coin_model
                    if ($pathinfo === '/admin/coin/model') {
            ...
            if (0 === strpos($pathinfo, '/admin/edu_cloud')) {
                ...
                // admin_edu_cloud_sms
                if ($pathinfo === '/admin/edu_cloud/sms') {
        ...
        if (0 === strpos($pathinfo, '/mapi_v')) {
            ...
            if (0 === strpos($pathinfo, '/mapi_v2')) {
                ...
                if ($pathinfo === '/mapi_v2/groupApp') {
                    return array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\GroupAppController::indexAction',  '_route' => 'mapi_mobile_group_app',);
                }

                if (0 === strpos($pathinfo, '/mapi_v2/articleApp')) {
                    // mapi_mobile_article_app
                    if ($pathinfo === '/mapi_v2/articleApp') {
                        return array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\ArticleAppController::indexAction',  '_route' => 'mapi_mobile_article_app',);
                    }

                    // mapi_mobile_article_app_list
                    if ($pathinfo === '/mapi_v2/articleApp/list') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_mapi_mobile_article_app_list;
                        }

                        return array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\ArticleAppController::listAction',  '_route' => 'mapi_mobile_article_app_list',);
                    }
                    not_mapi_mobile_article_app_list:

                    // mapi_mobile_article_app_category
                    if ($pathinfo === '/mapi_v2/articleApp/category') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_mapi_mobile_article_app_category;
                        }

                        return array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\ArticleAppController::categoryAction',  '_route' => 'mapi_mobile_article_app_category',);
                    }
                    not_mapi_mobile_article_app_category:

                    // mapi_mobile_article_detail_list
                    if (0 === strpos($pathinfo, '/mapi_v2/articleApp/detail') && preg_match('#^/mapi_v2/articleApp/detail/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'mapi_mobile_article_detail_list')), array (  '_controller' => 'Topxia\\MobileBundleV2\\Controller\\ArticleAppController::detailAction',));
                    }
